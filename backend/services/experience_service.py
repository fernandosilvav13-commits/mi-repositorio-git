...
EE_PATTERNS = [
    "liceo", "liceo politecnico", "liceo bicentenario", "liceo técnico",
    "liceo técnico profesional", "colegio", "escuela", "escuela básica",
    "escuela especial", "instituto", "instituto profesional",
    "instituto superior", "centro", "centro educacional",
    "centro de formación técnica", "cft", "complejo educacional",
    "corporación educacional", "high school", "politécnico",
    "tecnológico", "jardín", "jardín infantil",
    "fundación educacional", "sociedad educacional",
    "lycée", "gymnasium",
]


def is_educational_establishment(name: str) -> bool:
    if not name:
        return False
...
def crossref_experiences(exps: list, me_lookup: dict) -> list:
    ...
    for exp in exps:
        ...
        if not is_educational_establishment(name):
            exp["matricula"] = "NO EE"
            result.append(exp)
            continue
