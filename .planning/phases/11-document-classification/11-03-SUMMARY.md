...
- `backend/app/api/classify.py` — FastAPI router for classification endpoint (POST /api/classify)
- `backend/tests/test_classification_integration.py` — 6 integration tests covering full flow, edge cases, and module singleton
