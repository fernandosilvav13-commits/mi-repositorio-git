...
- Modified `backend/app/services/cv_processor.py` — _post_process now accepts raw_text and runs rule evaluation
- `backend/tests/test_rules_integration.py` — 4 integration tests covering rule application, non-override, empty text, full shadow run
